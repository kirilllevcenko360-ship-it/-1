...
class World:
    def __init__(self, data):
        tile10_img = pygame.image.load('images/tile10.png')
        tile9_img = pygame.image.load('images/tile9.png')
        self.tile_list = []
        row_count = 0
        for row in data:
            col_count = 0
            for tile in row:
                if tile == 1 or tile == 2:
                    images = { 1: tile10_img, 2: tile9_img }
...
bg_image = pygame.image.load('images/player1.png')
...
bg_image = pygame.image.load('images/bg11.png')
bg_rect = bg_image.get_rect()
